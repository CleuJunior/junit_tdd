...
class CourseBusinessMockWithBDDTest {
    ...
    void setup() {
        ...
        // Given / Arrange
        this.mockService = mock(CourseService.class);
        this.business = new CourseBusiness(mockService);
    ...
    void testCoursesRelatedToSpring_When_UsingAMock() {
        ...
        // When / Act
        List<String> filteredCourses = this.business.retriveCoursesRelatedToSpring("Leandro");
    ...
    void testDeleteCoursesNotRelatedToSpring_UsingMockitoVerify_Should_CallMethod_deleteCourse() {
        ...
        // When / Act
        this.business.deleteCoursesNotRelatedToSpring("Leandro");
